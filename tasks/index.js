...
task("test", "Enable faucet for testing")
	.setAction(async (_args, hre) => {
		...
		const nft = await hre.ethers.getContractAt('CoinmapDex', dex)
		const rs = await nft.verify(signer, {
		...
		console.log(await nft.ORDER_TYPEHASH())
		console.log(rs)
	})